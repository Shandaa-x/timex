...
/// A class that contains all theme configurations for the meal planning application.
class AppTheme {
  AppTheme._();

  // Nourishing Neutrals with Organic Accents Color Palette
  static const Color primaryLight = Color(0xFF2D5A27); // Deep forest green
  static const Color primaryVariantLight =
      Color(0xFF1E3F1A); // Darker forest green
  static const Color secondaryLight = Color(0xFFF4A261); // Warm amber
  static const Color secondaryVariantLight = Color(0xFFE76F51); // Deeper amber
  static const Color backgroundLight =
      Color(0xFFFEFEFE); // Pure white with subtle warmth
  static const Color surfaceLight = Color(0xFFF8F9FA); // Soft gray for cards
  static const Color errorLight = Color(0xFFE74C3C); // Muted red
  static const Color successLight = Color(0xFF27AE60); // Fresh green
  static const Color warningLight = Color(0xFFF39C12); // Gentle orange
  static const Color accentLight = Color(0xFF8E44AD); // Subtle purple
  static const Color onPrimaryLight = Color(0xFFFFFFFF);
  static const Color onSecondaryLight = Color(0xFF2C3E50);
  static const Color onBackgroundLight = Color(0xFF2C3E50); // Deep charcoal
  static const Color onSurfaceLight = Color(0xFF2C3E50);
  static const Color onErrorLight = Color(0xFFFFFFFF);

  // Dark theme colors (adapted for meal planning context)
  static const Color primaryDark = Color(0xFF4A8B3A); // Lighter forest green
  static const Color primaryVariantDark =
      Color(0xFF2D5A27); // Original forest green
  static const Color secondaryDark = Color(0xFFF4A261); // Warm amber (same)
  static const Color secondaryVariantDark = Color(0xFFE76F51); // Deeper amber
  static const Color backgroundDark = Color(0xFF1A1A1A); // Warm dark background
  static const Color surfaceDark = Color(0xFF2A2A2A); // Dark surface
  static const Color errorDark = Color(0xFFE74C3C); // Muted red (same)
  static const Color successDark = Color(0xFF27AE60); // Fresh green (same)
  static const Color warningDark = Color(0xFFF39C12); // Gentle orange (same)
  static const Color accentDark = Color(0xFF8E44AD); // Subtle purple (same)
  static const Color onPrimaryDark = Color(0xFFFFFFFF);
  static const Color onSecondaryDark = Color(0xFF2C3E50);
  static const Color onBackgroundDark = Color(0xFFE8E8E8); // Light text on dark
  static const Color onSurfaceDark = Color(0xFFE8E8E8);
  static const Color onErrorDark = Color(0xFFFFFFFF);

  // Text colors with proper emphasis levels
  static const Color textPrimaryLight = Color(0xFF2C3E50); // Deep charcoal
  ...
  static const Color textPrimaryDark = Color(0xFFE8E8E8); // Light text
  static const Color textSecondaryDark = Color(0xFFB0B0B0); // Medium light gray
  static const Color textDisabledDark = Color(0xFF6B6B6B); // Dark gray

  // Border and divider colors
  static const Color borderLight = Color(0xFFE1E8ED); // Minimal border color
  ...
  /// Light theme optimized for meal planning
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for meal planning context
    ...
    // Bottom navigation optimized for meal planning
  ...
  /// Dark theme optimized for meal planning
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Body styles - Inter Regular/Medium for extended reading
  ...
  /// Custom text styles for specific meal planning contexts
  ...
  static TextStyle nutritionLabelStyle({required bool isLight}) {
  ...
  static TextStyle recipeInstructionStyle({required bool isLight}) {
