...
class _FoodReportScreenState extends State<FoodReportScreen>
  ...
  Future<void> _loadPaymentHistory() async {
    try {
      // Payment history loading can be done when needed
      // final paymentHistory = await PaymentService.loadPaymentHistory(_selectedMonth);
    } catch (e) {
              ...
              DailyTabScreen(
                ...
                onMarkMealAsPaid:
                    (String mealId, int amount, Map<String, dynamic> food) {
                      setState(() => _paidMeals[mealId] = true);
                    },
